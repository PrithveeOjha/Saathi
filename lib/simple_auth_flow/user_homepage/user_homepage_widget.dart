...
import 'user_homepage_model.dart';
export 'user_homepage_model.dart';
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed('user_route_input');
                      },
                      child: RichText(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('driver_route_input');
                      },
                      child: RichText(
                        textScaleFactor: MediaQuery.of(context).textScaleFactor,
                        text: TextSpan(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 300.0, 0.0),
                child: Text(
                  'Routes\n',
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  5.0, 0.0, 0.0, 0.0),
                              child: Text(
                                'LAL KUAN, GHAZIABAD, UTTAR PRADESH',
